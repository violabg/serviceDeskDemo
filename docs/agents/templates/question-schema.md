...
Derived from `.agents/skills/bootstrap-agentic-system/templates/question-schema.md`.

Use this schema for generated Planner agents when they need user answers before implementation planning can become approval-ready. The schema governs both the `clarification-questions.md` artifact and the user-facing chat prompt.
