...
- Use `the active platform repository-search binding` for repository discovery when the workflow requires codebase evidence.
...
| `#capability:visual-evidence`             | Use the visual-evidence binding in `.agents/platforms/capabilities.md`.                                                    |
| `#capability:work-item-comment-retrieval` | Read Planner-captured comments in the current session evidence. Missing evidence requires a Planner handoff; do not retrieve tracker data directly.                                                              |
| `#capability:work-item-retrieval`         | Read Planner-captured issue evidence in the current session. Missing evidence requires a Planner handoff; do not retrieve tracker data directly.                                                         |
...
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Work-item tracker access     | `#capability:work-item-comment-retrieval`, `#capability:work-item-retrieval`                                                                                                                                                                                                                                                                                                                                                                                                           | Read issue, story, type, or comment evidence. Follow `.agents/platforms/capabilities.md`; no local tracker fallback is approved.                                                                     |
...
After applying the fixes, run the platform diagnostics binding and the relevant test commands to validate that the applied fixes effectively address the exposed issues and that all tests are passing.
