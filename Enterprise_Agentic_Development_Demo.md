...
artifacts/ session-id/ analysis.md questions.md spec.md
implementation-plan.md changed-files.md test-plan.md
...
Ogni nuova feature viene sviluppata tramite: Issue → Planner → Spec →
Piano → Implementazione → Test → Review → Pull Request
