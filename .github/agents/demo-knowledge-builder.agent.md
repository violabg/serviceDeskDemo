...
- Evaluate `README.md, docs/agents/*.md, docs/agents/knowledge/*.md` as candidate source material before proposing knowledge-index entries.
...
- Maintain knowledge-index entries in `docs/agents/knowledge/README.md` and keep `When to read` triggers specific enough to avoid bulk-loading repository knowledge.
