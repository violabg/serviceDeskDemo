# Shared role: demo-integration-tester
...
- Run the platform diagnostics binding and classify every diagnostic according to the Compiler Recovery Policy.
- Repair every Category A diagnostic without repository exploration.
- Run the platform diagnostics binding again after each repair iteration.
...
1. Prepare every test modification.
2. Apply every file modification.
3. Run the platform diagnostics binding once.
4. Fix all Category A diagnostics.
5. Run the platform diagnostics binding again.
