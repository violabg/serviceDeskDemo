-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('Open', 'InProgress', 'Pending', 'Resolved', 'Closed');
...
-- CreateEnum
CREATE TYPE "IntakeChannel" AS ENUM ('Email', 'Phone', 'Portal', 'Chat', 'WalkIn');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('Created', 'StatusChanged', 'PriorityChanged', 'AssigneeChanged', 'NoteAdded', 'AssetLinked');
...
CREATE TABLE "Ticket" (
    ...
    "pendingAssetLink" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "Permission_section_operation_key" ON "Permission"("section", "operation");
